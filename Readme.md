 To set up the project, start by cloning the repository and navigating into the project folder using the terminal commands git clone <repository-url> and cd <repository-folder>. 
